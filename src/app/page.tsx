...
type SectionKey = 'cv' | 'text' | 'works' | 'contact';
...
export default function Home() {
  const [active, setActive] = useState<SectionKey>('cv');
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-30 bg-bg/95 backdrop-blur border-b border-line">
        <div className="px-8 md:px-14 lg:px-20 h-16 flex items-center justify-between">
          <button onClick={() => setActive('cv')} className="text-left">
