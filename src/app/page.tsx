        ...
        <div className="md:hidden">
          ...
          <div className="px-5 h-12 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <button
                onClick={() => setLang('ko')}
                className={`text-[10px] tracking-wider uppercase transition-all duration-200 ${lang === 'ko' ? 'text-ink font-medium [filter:blur(0.6px)]' : 'text-muted hover:text-ink hover:[filter:blur(0.6px)]'}`}
              >KR</button>
              <span className="text-muted text-[9px]">/</span>
              <button
                onClick={() => setLang('en')}
                className={`text-[10px] tracking-wider uppercase transition-all duration-200 ${lang === 'en' ? 'text-ink font-medium [filter:blur(0.6px)]' : 'text-muted hover:text-ink hover:[filter:blur(0.6px)]'}`}
              >EN</button>
            </div>
          </div>
          {/* Row 2: nav */}
            ...
            <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-1">
              <button
                ...
                className={`text-[11px] tracking-wider2 uppercase transition-all duration-200 ${
                  lang === 'ko' ? 'text-ink font-medium [filter:blur(0.7px)]' : 'text-muted hover:text-ink hover:[filter:blur(0.7px)]'
                }`}
              >KR</button>
              ...
              <button
                onClick={() => setLang('en')}
                className={`text-[11px] tracking-wider2 uppercase transition-all duration-200 ${
                  lang === 'en' ? 'text-ink font-medium [filter:blur(0.7px)]' : 'text-muted hover:text-ink hover:[filter:blur(0.7px)]'
                }`}
              >EN</button>
            </div>
