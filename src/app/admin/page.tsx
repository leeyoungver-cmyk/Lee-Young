    ...
    <div className="fixed inset-0 z-50 bg-bg overflow-y-auto">
      <div className="max-w-3xl mx-auto px-6 md:px-10 py-10">
        <div className="flex items-center justify-between">
          ...
          <button onClick={onClose} className="text-[12px] tracking-wider2 uppercase hover:opacity-60">
            Cancel ✕
          </button>
        </div>
        ...
        <div className="mt-10 space-y-8">
          <Field label="Title">
            <input
              ...
              className="w-full border-b border-ink/40 py-2 text-[16px] focus:outline-none focus:border-ink"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Field label="Medium">
              <input
                ...
                className="w-full border-b border-ink/40 py-2 text-[15px] focus:outline-none focus:border-ink"
                placeholder="Mixed media, video installation…"
              />
            </Field>
          </div>
                ...
                <li key={i} className="grid grid-cols-[80px_1fr_auto] gap-4 items-start py-3 border-t border-line">
                  ...
                  <div className="flex flex-col gap-2">
                    <input
                      ...
                      className="w-full border-b border-line py-1 text-[13px] focus:outline-none focus:border-ink"
                    />
          ...
          <div className="flex items-center gap-4 pt-4">
            ...
            <button
              onClick={onClose}
              className="text-[12px] tracking-wider2 uppercase text-muted hover:text-ink"
            >
              Cancel
            </button>
          </div>
