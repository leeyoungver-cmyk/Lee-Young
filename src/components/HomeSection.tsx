...
export default function HomeSection() {
  ...
  return (
    <div className="relative w-full h-[calc(100vh-88px)] md:h-[calc(100vh-64px)] select-none overflow-hidden">
      ...
      <div className="field-blur w-[55vw] h-[55vw] left-[-10vw] top-[10vh]" style={{ background: 'radial-gradient(circle, rgba(180,190,220,0.45), transparent 70%)' }} />
      <div className="field-blur w-[45vw] h-[45vw] right-[-8vw] bottom-[5vh]" style={{ background: 'radial-gradient(circle, rgba(210,200,220,0.4), transparent 70%)' }} />
