    ...
    >
      <div className="max-w-4xl mx-auto px-5 md:px-14 py-8 md:py-10">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="text-[11px] tracking-wider2 uppercase hover:[filter:blur(0.7px)] active:[filter:blur(0.7px)] focus:[filter:blur(0.7px)] transition-all duration-500"
            aria-label="Close"
          >
            Close ✕
          </button>
        ...
        <div className="mt-24 mb-8 flex justify-center">
          <button
            onClick={onClose}
            className="text-[11px] tracking-wider2 uppercase text-muted hover:text-ink hover:[filter:blur(0.7px)] active:text-ink active:[filter:blur(0.7px)] focus:text-ink focus:[filter:blur(0.7px)] transition-all duration-500"
          >
            ← Back to Works
          </button>
        </div>
